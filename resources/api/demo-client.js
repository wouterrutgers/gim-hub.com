  ...
  return [
    {
      id: 1,
      senderName: "Thurgo",
      colorHueDegrees: colorFor("Thurgo"),
      message: "Just banked another load, pies are flying out",
      sentAt: new Date(now - 18 * MINUTES),
    },
    {
      id: 2,
      senderName: "Cow31337Killer",
      colorHueDegrees: colorFor("Cow31337Killer"),
      message: "You're going to smell like redberry forever lol",
      sentAt: new Date(now - 15 * MINUTES),
    },
    {
      id: 3,
      senderName: "Thurgo",
      colorHueDegrees: colorFor("Thurgo"),
      message: "Worth it, cooking xp is insane",
      sentAt: new Date(now - 13 * MINUTES),
    },
    {
      id: 4,
      senderName: "Cow31337Killer",
      colorHueDegrees: colorFor("Cow31337Killer"),
      message: "Almost at 10k kills, cows have no chance",
      sentAt: new Date(now - 10 * MINUTES),
    },
    {
      id: 5,
      senderName: "Thurgo",
      colorHueDegrees: colorFor("Thurgo"),
      message: "lmaoo get them",
      sentAt: new Date(now - 7 * MINUTES),
    },
    ...(elapsed >= 0.5 * MINUTES
      ? [
          {
      ...
      ? [
          {
            ...
            senderName: "Cow31337Killer",
            colorHueDegrees: colorFor("Cow31337Killer"),
            message: "gz on the bank trip",
            sentAt: new Date(now - 1 * MINUTES),
          },
        ]
      : []),
  ];
